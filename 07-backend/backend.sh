...
ansible-pull -i localhost, -U https://github.com/aikdp/expense-ansible-tf-roles.git main.yaml -e component=$comp -e environment=$env #passing terraform variables to shell, shell to ansible
